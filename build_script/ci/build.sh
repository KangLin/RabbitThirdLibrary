...
RABBIT_LIBRARYS[0]="change_prefix zlib minizip expat libgpx openssl libsodium libcurl libpng jpeg libgif libtiff freetype ogg speex libyuv libvpx libqrencode libopus x264 ffmpeg"
