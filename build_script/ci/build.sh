...
RABBIT_LIBRARYS[0]="change_prefix zlib expat libgpx openssl libsodium libcurl libpng jpeg libgif libtiff freetype ogg speexdsp speex libyuv libvpx libqrencode libopus x264 ffmpeg"
