...
if [ "$RABBIT_BUILD_STATIC" = "static" ]; then
    CMAKE_PARA="${CMAKE_PARA} -DGEOS_BUILD_STATIC=ON -DGEOS_BUILD_SHARED=OFF" 
else
    CMAKE_PARA="${CMAKE_PARA} -DGEOS_BUILD_STATIC=OFF -DGEOS_BUILD_SHARED=ON"
fi
...
echo "cmake .. ${CMAKE_PARA} -DCMAKE_INSTALL_PREFIX=$RABBIT_BUILD_PREFIX -DCMAKE_BUILD_TYPE=Release -G\"${GENERATORS}\" ${CMAKE_PARA}"
cmake .. \
