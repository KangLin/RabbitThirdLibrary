...
case ${RABBIT_BUILD_TARGERT} in
    android)
        ...
        CMAKE_PARA="${CMAKE_PARA} -DANDROID_ABI=${BUILD_ARCH}" 
...
CMAKE_PARA="${CMAKE_PARA} -DBUILD_JAVA=ON -DBUILD_FAT_JAVA_LIB=NO -DBUILD_opencv_java=OFF"
...
CMAKE_PARA="${CMAKE_PARA} -DWITH_IPP=OFF -DBUILD_JAVA=OFF"
